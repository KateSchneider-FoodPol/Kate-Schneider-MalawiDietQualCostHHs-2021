...
Purpose: Merge IHPS and Market data and prepare for linear programming
...
cd "yourfilepath"
log using "04_MergeIHPSandMarketDataLPInput_`c(current_date)'", replace
...
saveold "HH+CPI_LPInput_sharing.dta", replace
